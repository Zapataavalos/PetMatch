...
public class PaisService {
    ...
    private final PaisEventPublisher paisEventPublisher;

    public PaisService(PaisRepository paisRepository, PaisEventPublisher paisEventPublisher) {
        this.paisRepository = paisRepository;
        this.paisEventPublisher = paisEventPublisher;
    }
    ...
    public PaisResponseDTO crearPais(PaisRequestDTO requestDTO) {
        ...
        paisEventPublisher.publicarPaisCreado(paisGuardado);
    ...
    public PaisResponseDTO actualizarPais(Integer idPais, PaisRequestDTO requestDTO) {
        ...
        paisEventPublisher.publicarPaisActualizado(paisActualizado);
    ...
    public void eliminarPais(Integer idPais) {
        ...
        paisEventPublisher.publicarPaisEliminado(pais);
    }
